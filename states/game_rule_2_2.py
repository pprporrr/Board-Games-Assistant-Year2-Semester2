...
class Game_rule_2_2(State):
    def __init__(self, game):
        ...
        self.Previous = Button("", "Lexend-VariableFont_wght.ttf", 28, (255, 255, 255), (0, 0, 0), (166, 35), (344, 781))
        ...
        self.Components_text = Button("Components", "Alatsi-Regular.ttf", 20, (255, 255, 255), (0, 0, 0), (110, 26), (155, 275))
    ...
    def update(self, delta_time, action):
        ...
        if self.Previous.pressed == True:
            self.Previous.pressed = False
            self.exit_state()
    ...
    def render(self, display):
        ...
        self.Bg.draw_image(display, 'Game_rule2.2.png')
        self.Previous.draw_image(display, 'Previous.png')
        ...
        self.Components_box.draw_image(display, 'Selected_header.png')
