...
class Game_rule_4_2(State):
    def __init__(self, game):
        ...
        self.GamePlay_text = Button("Game play", "Alatsi-Regular.ttf", 20, (255, 255, 255), (0, 0, 0), (90, 26), (165, 412))
    ...
    def render(self, display):
        ...
        self.Bg.draw_image(display, 'Game_rule4.2.png')
        ...
        self.GamePlay_box.draw_image(display, 'Selected_header.png')
