...
class No_winer(State):
    def __init__(self, game):
        ...
        self.No_winner = Button("No winner!", "Amita-Regular.ttf", 72, (238, 215, 10), (255, 255, 255), (354, 140), (626, 357))
        self.Describe = Button("change a leader", "Amita-Regular.ttf", 36, (255, 255, 255), (255, 255, 255), (268, 70), (668, 497))
    ...
    def render(self, display):
        ...
        self.No_winner.draw_text(display)
