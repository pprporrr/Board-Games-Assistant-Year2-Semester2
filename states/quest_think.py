...
class Quest_think(State):
    def __init__(self, game):
        ...
        self.Quest_time = Button("Quest time!", "Amita-Regular.ttf", 64, (238, 215, 10), (255, 255, 255), (327, 124), (637, 290))
        self.Describe1 = Button("selected team members vote", "Amita-Regular.ttf", 36, (255, 255, 255), (255, 255, 255), (460, 50), (570, 418))
        self.Describe2 = Button("for a result of the quest", "Amita-Regular.ttf", 36, (255, 255, 255), (255, 255, 255), (379, 50), (611, 468))
    ...
    def render(self, display):
        ...
        self.Quest_time.draw_text(display)
        self.Describe1.draw_text(display)
        self.Describe2.draw_text(display)
